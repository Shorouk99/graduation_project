...
const double TICKS_PER_REVOLUTION = 1100; // For reference purposes.
const double WHEEL_RADIUS = 0.06; // Wheel radius in meters
const double WHEEL_BASE = 0.29; // Center of left tire to center of right tire
const double TICKS_PER_METER = 2920; // Original was 2800-3100
