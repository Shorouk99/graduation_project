...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/shorouk/graduation_project/ros1_ws/src/differential_drive)
  set(differential_drive_DEVEL_PREFIX /home/shorouk/graduation_project/ros1_ws/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/shorouk/graduation_project/ros1_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'shorouk <shorouk@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shorouk/graduation_project/ros1_ws/src/differential_drive/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shorouk/graduation_project/ros1_ws/devel/lib;/home/shorouk/graduation_project/ros1_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(differential_drive_EXPORTED_TARGETS ${${differential_drive_dep}_EXPORTED_TARGETS})
endforeach()
