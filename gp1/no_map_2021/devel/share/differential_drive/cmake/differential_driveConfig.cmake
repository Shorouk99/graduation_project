...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/shorouk/graduation_project/no_map_2021/src/differential-drive)
  set(differential_drive_DEVEL_PREFIX /home/shorouk/graduation_project/no_map_2021/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/shorouk/graduation_project/no_map_2021/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shorouk/graduation_project/no_map_2021/src/differential-drive/${idir}'.  ${_report}")
    endif()
