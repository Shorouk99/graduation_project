...
## Overview
![Old Control Architecture's Overview] (/docs/old_control_arch_brief.png "Old Control Architecture's Overview") 
...
![Old Control Architecture's Detialed Description] (/docs/old_control_arch_detailed.png "Old Control Detialed Description") 
