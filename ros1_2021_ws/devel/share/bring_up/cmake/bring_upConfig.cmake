...
if("TRUE" STREQUAL "TRUE")
  set(bring_up_SOURCE_PREFIX /home/shorouk/graduation_project/ros1_2021_ws/src/bring_up)
  set(bring_up_DEVEL_PREFIX /home/shorouk/graduation_project/ros1_2021_ws/devel)
  set(bring_up_INSTALL_PREFIX "")
  set(bring_up_PREFIX ${bring_up_DEVEL_PREFIX})
else()
  set(bring_up_SOURCE_PREFIX "")
  set(bring_up_DEVEL_PREFIX "")
  set(bring_up_INSTALL_PREFIX /home/shorouk/graduation_project/ros1_2021_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bring_up' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shorouk/graduation_project/ros1_2021_ws/src/bring_up/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(bring_up_EXPORTED_TARGETS ${${bring_up_dep}_EXPORTED_TARGETS})
endforeach()
